...
if (!empty($_POST['tran_id'])) {
    ...
    mysqli_query($conn, "UPDATE payments SET payment_status='cancelled' WHERE transaction_id='$tran_id'");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<title>Payment Cancelled – MediConnect</title>
...
<div class="payment-result">
    <div class="result-card">
        ...
        <h2 style="color:#d97706;font-weight:800;margin-bottom:.5rem;">Payment Cancelled</h2>
        <p style="color:#6b7280;margin-bottom:.5rem;">You cancelled the payment.</p>
        <p style="color:#6b7280;font-size:.9rem;margin-bottom:2rem;">
            Your appointment is saved. You can pay anytime from your dashboard.
        </p>
